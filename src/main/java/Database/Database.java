...
import Controllers.IOReaderController;
...
public class Database {
	...
	public static void init () throws Exception {
		Database.addProjects(IOReaderController.getHTML(Configs.SERVICE_URL + "/project"));
		Database.addUsers();
		Database.addSkills(IOReaderController.getHTML(Configs.SERVICE_URL + "/skill"));
		didInit = true;
	}
